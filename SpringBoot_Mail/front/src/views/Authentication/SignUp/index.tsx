...
import {CheckCertificationRequestDto, IdCheckRequestDto, SignUpRequestDto} from "../../../apis/request/auth";
                ...
                <div className={'sign-up-box'}>
                    ...
                    <div className={'sign-up-content-box'}>
                        ...
                        <div className={'sign-up-content-input-box'}>
                            <InputBox ref={idRef} title={'아이디'} placeholder={'아이디를 입력해주세요'} type={'text'} value={id}  onChange={onIdChangeHandler} isErrorMessage={isIdError} message={idMessage} buttonTitle={'중복확인'} onButtonClick={onIdButtonClickHandler} onKeyDown={onIdKeyDownHandler}></InputBox>
                            <InputBox ref={passwordRef} title={'비밀번호'} placeholder={'비밀번호를 입력해주세요'} type={'password'} value={password} onChange={onPasswordChangeHandler} isErrorMessage={isPasswordError} message={passwordMessage} onKeyDown={onPasswordKeyDownHandler}></InputBox>
                            <InputBox ref={passwordCheckRef} title={'비밀번호 확인'} placeholder={'비밀번호를 입력해주세요'} type={'password'} value={passwordCheck} onChange={onPasswordCheckChangeHandler} isErrorMessage={isPasswordCheckError} message={passwordCheckMessage} onKeyDown={onPasswordCheckKeyDownHandler}></InputBox>
                            <InputBox ref={emailRef} title={'이메일'} placeholder={'이메일 주소를 입력해주세요'} type={'text'} value={email} onChange={onEmailChangeHandler} isErrorMessage={isEmailError} message={emailMessage} buttonTitle={'이메일 인증'} onButtonClick={onEmailButtonClickHandler} onKeyDown={onEmailKeyDownHandler}></InputBox>
